...
wave_lengthv = clean_numeric_column(t2['obs_wl_vac(nm)'])
A21 = clean_numeric_column(t2['Aki(s^-1)']) * 1e8 / u.s
Ji = clean_J_column(t2['J_i'])
Jk = clean_J_column(t2['J_k'])
...
plt.title('Einstein B Coefficient for Potassium Atom Transitions')
plt.grid(True)
plt.show()