...
t = Table.read('Spectral/Na(2).csv')
...
wave_lengthv = clean_numeric_column(t['obs_wl_vac(nm)'])
A21 = clean_numeric_column(t['Aki(s^-1)']) * 1e8 / u.s
Ji = clean_J_column(t['J_i'])
Jk = clean_J_column(t['J_k'])
